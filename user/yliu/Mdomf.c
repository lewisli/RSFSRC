...
{
    int n1, n2, n3, n12, i1, i2, i3, j, m, *coor, xc, yc, nw, fold;
    bool boundary, verb, stack;
    
    float *input, *output, *dd, *data, temp;
    sf_file in, out, dip;
	...
	for(i2=0; i2 < n2; i2++) {
		...
		if (stack) {
		    ...
		    output[i2*n1+i1] = temp;
		} else {
		    output[i2*n1+i1] = medianfilter(data,nw);
		}
	    }
	}
...
/* 	$Id: Mdomf.c 4796 2009-09-29 19:39:07Z ivlad $	 */
